...
public class _FrontTemperatureStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements fr.esiag.commun.FrontTemperature
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = fr.esiag.commun.FrontTemperatureOperations.class;
	public double calculFrontTemperature(double altitude, double speed)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "calculFrontTemperature", true);
					_os.write_double(altitude);
					_os.write_double(speed);
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "calculFrontTemperature", _opsClass );
			if( _so == null )
				continue;
			FrontTemperatureOperations _localServant = (FrontTemperatureOperations)_so.servant;
			double _result;
			try
			{
				_result = _localServant.calculFrontTemperature(altitude,speed);
