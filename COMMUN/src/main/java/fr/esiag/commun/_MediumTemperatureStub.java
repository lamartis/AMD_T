...
public class _MediumTemperatureStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements fr.esiag.commun.MediumTemperature
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = fr.esiag.commun.MediumTemperatureOperations.class;
	public void rollback() throws fr.esiag.commun.TransactionException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			MediumTemperatureOperations _localServant = (MediumTemperatureOperations)_so.servant;
			try
			{
	...
	public double calculMediumTemperature(double ft)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "calculMediumTemperature", true);
					_os.write_double(ft);
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "calculMediumTemperature", _opsClass );
			if( _so == null )
				continue;
			MediumTemperatureOperations _localServant = (MediumTemperatureOperations)_so.servant;
			double _result;
			try
			{
				_result = _localServant.calculMediumTemperature(ft);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
