...
public abstract class ManageAproveDemandPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, fr.esiag.commun.ManageAproveDemandOperations
{
	static private final java.util.HashMap<String,Integer> m_opsHash = new java.util.HashMap<String,Integer>();
	static
	{
		m_opsHash.put ( "aproveDemand", Integer.valueOf(0));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			case 0: // aproveDemand
			{
				...
				java.lang.String tmpResult4 = aproveDemand(_arg0);
