...
public class _GlobalSensorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements fr.esiag.commun.GlobalSensor
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = fr.esiag.commun.GlobalSensorOperations.class;
	public void rollback() throws fr.esiag.commun.TransactionException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			GlobalSensorOperations _localServant = (GlobalSensorOperations)_so.servant;
			try
			{
	...
	public double calculGlobalTempareature(double mt)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "calculGlobalTempareature", true);
					_os.write_double(mt);
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "calculGlobalTempareature", _opsClass );
			if( _so == null )
				continue;
			GlobalSensorOperations _localServant = (GlobalSensorOperations)_so.servant;
			double _result;
			try
			{
				_result = _localServant.calculGlobalTempareature(mt);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
