...
public class _TransactionResourceStub
	...
	implements fr.esiag.commun.TransactionResource
{
	/** Serial version UID. */
	...
	public java.lang.String getReference()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getReference", true);
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getReference", _opsClass );
			if( _so == null )
				continue;
			TransactionResourceOperations _localServant = (TransactionResourceOperations)_so.servant;
			...
			try
			{
				_result = _localServant.getReference();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
