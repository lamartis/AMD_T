...
public class _ManageAproveDemandStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements fr.esiag.commun.ManageAproveDemand
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:transaction/ManageAproveDemand:1.0","IDL:transaction/TransactionResource:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = fr.esiag.commun.ManageAproveDemandOperations.class;
	public java.lang.String aproveDemand(java.lang.String demand)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "aproveDemand", true);
					java.lang.String tmpResult3 = demand;
_os.write_string( tmpResult3 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "aproveDemand", _opsClass );
			if( _so == null )
				continue;
			ManageAproveDemandOperations _localServant = (ManageAproveDemandOperations)_so.servant;
			java.lang.String _result;
			try
			{
				_result = _localServant.aproveDemand(demand);
	...
	public void prepare() throws fr.esiag.commun.NotPreparedException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				catch( org.omg.CORBA.portable.ApplicationException _ax )
				{
					...
					try
					{
						if( _id.equals("IDL:transaction/NotPreparedException:1.0"))
						{
							throw fr.esiag.commun.NotPreparedExceptionHelper.read(_ax.getInputStream());
						}
						else 
						{
							throw new RuntimeException("Unexpected exception " + _id );
		...
		else
		{
			...
			try
			{
				_localServant.prepare();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
			catch (fr.esiag.commun.NotPreparedException ex) 
			{
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).exceptionalCompletion(ex);
				throw ex;
