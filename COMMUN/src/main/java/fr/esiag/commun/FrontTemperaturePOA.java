...
public abstract class FrontTemperaturePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, fr.esiag.commun.FrontTemperatureOperations
{
	static private final java.util.HashMap<String,Integer> m_opsHash = new java.util.HashMap<String,Integer>();
	static
	{
		m_opsHash.put ( "calculFrontTemperature", Integer.valueOf(0));
		m_opsHash.put ( "rollback", Integer.valueOf(1));
		m_opsHash.put ( "commit", Integer.valueOf(2));
		m_opsHash.put ( "prepare", Integer.valueOf(3));
	}
	private String[] ids = {"IDL:transaction/FrontTemperature:1.0","IDL:transaction/TransactionResource:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		{
			case 0: // calculFrontTemperature
			{
				double _arg0=_input.read_double();
				double _arg1=_input.read_double();
				_out = handler.createReply();
				_out.write_double(calculFrontTemperature(_arg0,_arg1));
				break;
			}
			case 1: // rollback
			{
